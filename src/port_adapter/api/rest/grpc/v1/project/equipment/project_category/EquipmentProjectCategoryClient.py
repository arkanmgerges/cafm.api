...
from src.resource.proto._generated.project.equipment_project_category_app_service_pb2 import \
    ...
    EquipmentProjectCategoryAppService_equipmentProjectCategorysRequest, EquipmentProjectCategoryAppService_equipmentProjectCategoryByIdRequest, \
    EquipmentProjectCategoryAppService_equipmentProjectCategoryByIdResponse
from src.resource.proto._generated.project.equipment_project_category_app_service_pb2_grpc import EquipmentProjectCategoryAppServiceStub
...
class EquipmentProjectCategoryClient(Client):
    ...
    def equipmentProjectCategorys(self, resultFrom: int = 0, resultSize: int = 10, order: List[dict] = None) -> EquipmentProjectCategorys:
        ...
        with grpc.insecure_channel(f'{self._server}:{self._port}') as channel:
            ...
            try:
                ...
                request = EquipmentProjectCategoryAppService_equipmentProjectCategorysRequest(resultFrom=resultFrom, resultSize=resultSize)
                ...
                return EquipmentProjectCategorys(equipment_project_categorys=[self._descriptorByObject(obj=equipmentProjectCategory) for equipmentProjectCategory in
