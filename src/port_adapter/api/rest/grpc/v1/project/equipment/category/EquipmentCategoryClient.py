...
class EquipmentCategoryClient(Client):
    ...
    def equipmentCategorys(self, resultFrom: int = 0, resultSize: int = 10,
                           order: List[dict] = None) -> EquipmentCategorys:
        ...
        with grpc.insecure_channel(f'{self._server}:{self._port}') as channel:
            ...
            try:
                ...
                request = EquipmentCategoryAppService_equipmentCategorysRequest(resultFrom=resultFrom,
                ...
                return EquipmentCategorys(
                    equipment_categorys=[self._descriptorByObject(obj=equipmentCategory) for equipmentCategory in
    ...
    @OpenTelemetry.grpcTraceOTel
    def categoryGroupsByCategoryId(self, id: str, resultFrom: int = 0, resultSize: int = 10,
        ...
        with grpc.insecure_channel(f'{self._server}:{self._port}') as channel:
            ...
            try:
                ...
                request = EquipmentCategoryAppService_equipmentCategoryGroupsByCategoryIdRequest(id=id,
