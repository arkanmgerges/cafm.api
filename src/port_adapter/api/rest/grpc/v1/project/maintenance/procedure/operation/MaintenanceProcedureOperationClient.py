...
from src.resource.proto._generated.project.maintenance_procedure_operation_app_service_pb2 import \
    ...
    MaintenanceProcedureOperationAppService_newIdRequest, MaintenanceProcedureOperationAppService_newIdResponse
            ...
            try:
                ...
                response: MaintenanceProcedureOperationAppService_newIdResponse = stub.newId.with_call(
                    ...
                    metadata=(('token', self.token), (
                        'opentel', AppDi.instance.get(OpenTelemetry).serializedContext(MaintenanceProcedureOperationClient.newId.__qualname__))))
                logger.debug(
