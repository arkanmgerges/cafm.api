...
class MaintenanceProcedureClient(Client):
    ...
    @OpenTelemetry.grpcTraceOTel
    def maintenanceProcedures(self, resultFrom: int = 0, resultSize: int = 10,
                              order: List[dict] = None) -> MaintenanceProcedures:
        ...
        with grpc.insecure_channel(f'{self._server}:{self._port}') as channel:
            ...
            try:
                ...
                request = MaintenanceProcedureAppService_maintenanceProceduresRequest(resultFrom=resultFrom,
                ...
                return MaintenanceProcedures(
                    maintenance_procedures=[self._descriptorByObject(obj=maintenanceProcedure) for maintenanceProcedure
                                            in
    ...
    @OpenTelemetry.grpcTraceOTel
    def maintenanceProceduresByEquipmentId(self, equipmentId: str = None, resultFrom: int = 0, resultSize: int = 10,
                                           order: List[dict] = None) -> MaintenanceProcedures:
        order = [] if order is None else order
        with grpc.insecure_channel(f'{self._server}:{self._port}') as channel:
            stub = MaintenanceProcedureAppServiceStub(channel)
            try:
                ...
                request = MaintenanceProcedureAppService_maintenanceProceduresByEquipmentIdRequest(
                    equipmentId=equipmentId, resultFrom=resultFrom, resultSize=resultSize)
                [request.order.add(orderBy=o["orderBy"], direction=o["direction"]) for o in order]
