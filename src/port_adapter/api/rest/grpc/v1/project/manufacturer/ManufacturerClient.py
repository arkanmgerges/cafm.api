...
from src.resource.proto._generated.project.manufacturer_app_service_pb2 import \
    ...
    ManufacturerAppService_manufacturerByIdResponse, ManufacturerAppService_newIdRequest, \
            ...
            try:
                ...
                response: ManufacturerAppService_newIdResponse = stub.newId.with_call(
                    ...
                    metadata=(('token', self.token), (
                        'opentel', AppDi.instance.get(OpenTelemetry).serializedContext(ManufacturerClient.newId.__qualname__))))
                logger.debug(
