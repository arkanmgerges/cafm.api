...
class RedisCache:
    def __init__(self):
        try:
            ...
            self._cacheSessionPrefix = os.getenv('CAFM_IDENTITY_REDIS_SESSION_KEY_PREFIX', 'cafm.identity.session.')
            self._refreshTokenTtl = int(os.getenv('CAFM_IDENTITY_USER_AUTH_TTL_IN_SECONDS', 300))
