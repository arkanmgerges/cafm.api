...
from src.port_adapter.api.rest.model.response.v1.project.BuildingLevel import BuildingLevel
from src.port_adapter.api.rest.model.response.v1.project.BuildingLevelRoom import BuildingLevelRoom
...
@OpenTelemetry.fastApiTraceOTel
async def partialUpdateProject(*, _=Depends(CustomHttpBearer()),
                        project_id: str = Path(...,
                                               description='Project id that is used in order to update the project'),
...
@router.get(path="/{project_id}/buildings", summary='Get all buildings', response_model=Buildings)
@OpenTelemetry.fastApiTraceOTel
async def getBuildings(*, project_id: str = Path(...,
                                                 description='Project id that is used to fetch data'),
                       result_from: int = Query(0, description='Starting offset for fetching data'),
                       result_size: int = Query(10, description='Item count to be fetched'),
                       order: str = Query('', description='e.g. id:asc,name:desc'),
                       include: List[str] = Query('', description='values: "building_level", "building_level_room"'),
                       _=Depends(CustomHttpBearer())):
    try:
        client = ProjectClient()
        orderService = AppDi.instance.get(OrderService)
        order = orderService.orderStringToListOfDict(order)
        return client.buildings(resultFrom=result_from, resultSize=result_size, order=order, include=include,
...
@router.get(path="/{project_id}/buildings/{building_id}", summary='Get building', response_model=Building)
@OpenTelemetry.fastApiTraceOTel
...
@router.get(path="/{project_id}/buildings/{building_id}/building_levels", summary='Get building levels',
            response_model=BuildingLevels)
@OpenTelemetry.fastApiTraceOTel
async def getBuildingLevels(*, project_id: str = Path(...,
                                                      description='Project id that is used to fetch data'),
                            building_id: str = Path(...,
                                                    description='Building id that is used to fetch data'),
                            result_from: int = Query(0, description='Starting offset for fetching data'),
                            ...
                            include: List[str] = Query('',
                                                       description='values: "building_level_room"'),
                            _=Depends(CustomHttpBearer())):
    try:
        client = ProjectClient()
        orderService = AppDi.instance.get(OrderService)
        order = orderService.orderStringToListOfDict(order)
        return client.buildingLevels(resultFrom=result_from, resultSize=result_size, order=order, include=include,
...
@router.get(path="/{project_id}/buildings/{building_id}/building_levels/{building_level_id}",
            summary='Get building level by id', response_model=BuildingLevel)
@OpenTelemetry.fastApiTraceOTel
...
@router.delete("/{project_id}/buildings/{building_id}/building_levels/{building_level_id}", summary='Delete building level',
               status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
...
@router.put("/{project_id}/buildings/{building_id}/building_levels/{building_level_id}", summary='Update building level',
            status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
...
@router.put("/{project_id}/buildings/{building_id}/building_levels/{building_level_id}/link", summary='Link building level to building',
            status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
...
@router.put("/{project_id}/buildings/{building_id}/building_levels/{building_level_id}/unlink",
...
async def getBuildingLevelRooms(*, project_id: str = Path(...,
    ...
    try:
        ...
        orderService = AppDi.instance.get(OrderService)
        order = orderService.orderStringToListOfDict(order)
        return client.buildingLevelRooms(resultFrom=result_from, resultSize=result_size, order=order,
...
@router.post("/{project_id}/buildings/{building_id}/building_levels/{building_level_id}/building_level_rooms", summary='Add room to building level',
             status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
...
@router.delete("/{project_id}/buildings/{building_id}/building_levels/{building_level_id}/building_level_rooms/{building_level_room_id}",
...
@router.put("/{project_id}/buildings/{building_id}/building_levels/{building_level_id}/building_level_rooms/{building_level_room_id}",
