...
@router.get(
    path="",
    summary="Get all equipment project category(s)",
...
async def getEquipmentProjectCategories(
    *,
    ...
    try:
        ...
        return client.equipmentProjectCategories(
...
@router.get(
    path="/{equipment_project_category_id}",
    summary="Get equipment project category by id",
    response_model=EquipmentProjectCategoryDescriptor,
)
@OpenTelemetry.fastApiTraceOTel
async def getEquipmentProjectCategoryById(
    *,
...
@router.post(
    "", summary="Create equipment project category", status_code=status.HTTP_200_OK
)
@OpenTelemetry.fastApiTraceOTel
async def createEquipmentProjectCategory(
    *,
    ...
    producer.produce(
        obj=ProjectCommand(
            id=reqId,
            name=CommandConstant.CREATE_EQUIPMENT_PROJECT_CATEGORY.value,
...
@router.put(
    ...
    summary="Update equipment project category",
...
async def updateEquipmentProjectCategory(
    *,
    ...
    producer.produce(
        obj=ProjectCommand(
            id=reqId,
            name=CommandConstant.UPDATE_EQUIPMENT_PROJECT_CATEGORY.value,
            metadata=json.dumps({"token": Client.token}),
            data=json.dumps(
                {
...
@router.delete(
    "/{equipment_project_category_id}",
    summary="Delete a equipment project categories",
    status_code=status.HTTP_200_OK,
)
@OpenTelemetry.fastApiTraceOTel
async def deleteEquipmentProjectCategory(
    *,
    ...
    producer.produce(
        obj=ProjectCommand(
            id=reqId,
            name=CommandConstant.DELETE_EQUIPMENT_PROJECT_CATEGORY.value,
            metadata=json.dumps({"token": Client.token}),
            data=json.dumps(
                {"equipment_project_category_id": equipment_project_category_id}
            ),
...
@router.post(
    "/{equipment_project_category_id}/relate_to_category_group/{category_group_id}/link",
    summary="Link equipment project category and category group",
    status_code=status.HTTP_200_OK,
)
@OpenTelemetry.fastApiTraceOTel
async def linkEquipmentProjectCategoryToCategoryGroup(
    *,
    ...
    producer.produce(
        obj=ProjectCommand(
            id=reqId,
            name=CommandConstant.LINK_EQUIPMENT_PROJECT_CATEGORY_GROUP.value,
            metadata=json.dumps({"token": Client.token}),
            data=json.dumps(
                {
                    "equipment_project_category_id": equipment_project_category_id,
...
@router.delete(
    "/{equipment_project_category_id}/relate_to_category_group/{category_group_id}/unlink",
    summary="Unlink equipment project category and category group",
    status_code=status.HTTP_200_OK,
)
@OpenTelemetry.fastApiTraceOTel
async def unlinkEquipmentProjectCategoryFromCategoryGroup(
    *,
    ...
    producer.produce(
        obj=ProjectCommand(
            id=reqId,
            name=CommandConstant.UNLINK_EQUIPMENT_PROJECT_CATEGORY_GROUP.value,
            metadata=json.dumps({"token": Client.token}),
            data=json.dumps(
                {
                    "equipment_project_category_id": equipment_project_category_id,
...
@router.get(
    path="/{equipment_project_category_id}/equipment_category_groups",
    summary="Get all equipment category Groups",
...
async def getCategoryGroupsByProjectCategoryId(
    *,
    ...
    try:
        ...
        orderService = AppDi.instance.get(OrderService)
        orders = orderService.orderStringToListOfDict(orders)
        return client.categoryGroupsByProjectCategoryId(
            id=equipment_project_category_id,
