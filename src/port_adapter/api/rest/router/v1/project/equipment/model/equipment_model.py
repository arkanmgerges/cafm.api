...
async def getEquipmentModels(*,
    ...
    try:
        ...
        return client.equipmentModels(resultFrom=result_from, resultSize=result_size, order=order)
...
@router.get(path="/{equipment_model_id}", summary='Get equipment model by id',
...
async def create(*, _=Depends(CustomHttpBearer()),
    ...
    client = EquipmentModelClient()
    producer.produce(obj=ProjectCommand(id=reqId, name=CommandConstant.CREATE_EQUIPMENT_MODEL.value,
