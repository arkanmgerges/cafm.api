...
@OpenTelemetry.fastApiTraceOTel
async def AssignRoleToUser(*, _=Depends(CustomHttpBearer()),
...
@OpenTelemetry.fastApiTraceOTel
async def removeRoleToUserAssignment(*, _=Depends(CustomHttpBearer()),
...
@OpenTelemetry.fastApiTraceOTel
async def assignRoleToUserGroup(*, _=Depends(CustomHttpBearer()),
...
@OpenTelemetry.fastApiTraceOTel
async def removeRoleToUserGroupAssignment(*, _=Depends(CustomHttpBearer()),
...
@OpenTelemetry.fastApiTraceOTel
async def assignUserToUserGroup(*, _=Depends(CustomHttpBearer()),
...
@OpenTelemetry.fastApiTraceOTel
async def removeUserToUserGroupAssignment(*, _=Depends(CustomHttpBearer()),
...
@OpenTelemetry.fastApiTraceOTel
async def assignRoleToPermission(*, _=Depends(CustomHttpBearer()),
...
@router.delete("/role_to_permission",
               ...
               status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
async def removeRoleToPermissionAssignment(*, _=Depends(CustomHttpBearer()),
                 role_id: str = Body(...,
...
@router.post("/permission_to_permission_context", summary='Assign permission to permission context',
             status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
async def assignPermissionToPermissionContext(*, _=Depends(CustomHttpBearer()),
                 permission_id: str = Body(...,
...
@router.delete("/permission_to_permission_context",
               ...
               status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
async def removePermissionToPermissionContextAssignment(*, _=Depends(CustomHttpBearer()),
                 permission_id: str = Body(...,
...
@OpenTelemetry.fastApiTraceOTel
async def assignResourceToAnotherResource(*, _=Depends(CustomHttpBearer()),
...
@router.delete("/resource_to_resource", summary='Remove assignment of resource to another resource',
               status_code=status.HTTP_200_OK)
@OpenTelemetry.fastApiTraceOTel
async def removeResourceToAnotherResourceAssignment(*, _=Depends(CustomHttpBearer()),
