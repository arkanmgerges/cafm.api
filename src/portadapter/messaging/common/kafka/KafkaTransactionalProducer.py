...
class KafkaTransactionalProducer(TransactionalProducer):
    def __init__(self, schemaRegistry=None, transactionalId=str(uuid4())):
        ...
        self._producer = Producer({'bootstrap.servers': os.getenv('MESSAGE_BROKER_SERVERS', '')})
    ...
    def produce(self, obj: MessageBase, schema: str):
        ...
        self._producer.produce(topic=obj.topic(), key=str(uuid4()), value=obj,
