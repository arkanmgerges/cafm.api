...
# source: project/country_lookup.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='project/country_lookup.proto',
  package='cafm.project.lookup',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x1cproject/country_lookup.proto\x12\x13\x63\x61\x66m.project.lookup\")\n\rCountryLookup\x12\n\n\x02id\x18\x01 \x01(\x05\x12\x0c\n\x04name\x18\x02 \x01(\tb\x06proto3'
)
...
CountryLookup = _reflection.GeneratedProtocolMessageType('CountryLookup', (_message.Message,), {
  ...
  '__module__' : 'project.country_lookup_pb2'
