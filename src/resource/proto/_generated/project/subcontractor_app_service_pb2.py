...
_SUBCONTRACTORAPPSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='subcontractorsBySubcontractorsCategoryId',
    full_name='cafm.project.subcontractor.SubcontractorAppService.subcontractorsBySubcontractorsCategoryId',
    index=0,
